...
const AdminSidebar: React.FC<AdminSidebarProps> = ({ activeTab, setActiveTab }) => {
  ...
  return (
    <aside className="h-screen w-64 bg-white border-r border-gray-200 shadow-sm flex-shrink-0 hidden md:block">
      {/* Logo */}
      <div className="flex items-center justify-start h-16 px-6 border-b border-gray-200">
        <div className="flex items-center">
          ...
          <span className="ml-2 text-lg font-semibold text-green-600">Green Food Admin</span>
        </div>
      </div>
