    ...
    <div className="min-h-screen bg-[#F9FDF7] dark:bg-gray-900 text-gray-800 dark:text-gray-100 flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 py-12 max-w-3xl">
        <section className="mb-10">
          <h1 className="text-4xl font-bold text-green-700 dark:text-green-400 mb-4">Quem Somos</h1>
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-bold text-green-600 dark:text-green-300 mb-3">Nossa História</h2>
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-bold text-green-600 dark:text-green-300 mb-3">Nosso Compromisso</h2>
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-bold text-green-600 dark:text-green-300 mb-3">Uma Mensagem Para Você</h2>
          ...
          <p className="text-lg font-semibold text-green-700 dark:text-green-400">Bem-vindo(a) à sua nova rotina fitness.</p>
        </section>
      </main>
      <Footer />
    </div>
