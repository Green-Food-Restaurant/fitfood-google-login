    ...
    <div className="min-h-screen bg-[#F9FDF7] text-gray-800 flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 py-12 flex flex-col md:flex-row gap-12 items-center">
        <div className="flex-1 space-y-6">
          <h1 className="text-3xl font-bold text-green-700 mb-2">Fale Conosco</h1>
          ...
          <div className="space-y-2">
            ...
            <div>
              <span className="font-semibold">E-mail:</span> contato@greenfood.com.br
            </div>
          </div>
        </div>
